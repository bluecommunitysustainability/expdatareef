...
export const FileUploader: React.FC<FileUploaderProps> = ({ currentFile, onChange }) => {
  ...
  return (
    <div className="mt-2">
      <label 
        className="w-full flex items-center justify-center px-4 py-3 bg-gray-700 text-teal-300 rounded-md shadow-sm tracking-wide uppercase border border-gray-600 cursor-pointer hover:bg-gray-600 hover:text-teal-200 transition-colors"
        tabIndex={0}
