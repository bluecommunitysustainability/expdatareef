...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, size = 'default' }) => {
  ...
  return ReactDOM.createPortal(
    <div 
        ...
        onClick={size === 'default' ? onClose : undefined}
        role="dialog"
        aria-modal="true"
