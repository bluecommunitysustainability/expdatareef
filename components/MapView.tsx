...
export const MapView: React.FC<MapViewProps> = ({ destination, onPoiSelect, pois, setPois, mapboxToken, tours }) => {
            ...
            >
                <button className="transform transition-transform hover:scale-125 focus:outline-none">
                    <svg 
                        ...
                        style={{
                            color: poi.status === 'published' ? themeColorHex : '#a0aec0', // Gray for staged
                            stroke: 'white', 
                            strokeWidth: 1.5, 
